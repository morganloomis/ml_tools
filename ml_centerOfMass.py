...
#  /_/ /_/ /_/_/  _________                                   
#               /_________/  Revision 1, 2016-12-05
...
#     python("import ml_centerOfMass;ml_centerOfMass.ui()");
#      _________________
# - -/__ Description __/- - - - - - - - - - - - - - - - - - - - - - - - - - - 
#  
# Create a locator that approximates the Center of Mass for the character.
# This locator can be live and simply used as reference, or you can transfer
# the root animation of your character to the center of mass, and then
# back again after you've adjusted any motion.
# This workflow is helpful for debugging action animation when a characters
# body needs to move in a believable way.
#      ___________
# - -/__ Usage __/- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
# 
# Run the tool to launch the UI. Select the root control of your puppet.
# The tool may not error if you select something other than the root, but
# it may behave strangely, so it's up to you to choose the correct control.
# Then choose to either create a live COM node, or transfer your root animation
# to the center of mass. After transferring from Root to COM, you can
# then transfer back after editing.
#      __________________
# - -/__ Requirements __/- - - - - - - - - - - - - - - - - - - - - - - - - - 
# 
